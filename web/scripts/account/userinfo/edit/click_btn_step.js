...
function click_btn_step() {
	if (step_number == 1) {
		...
		document.getElementById("btn_complete").className = "rounded-lg w-[85px] h-[40px] bg-red-500 text-white text-[16px] font-[600] hover:bg-red-600 focus:border focus:border-[#FFFFFF]"
