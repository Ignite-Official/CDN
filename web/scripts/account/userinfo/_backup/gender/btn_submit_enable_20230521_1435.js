...
function select_btn_gender(mode) {
	...
	const class_btn_male_inactive = class_btn_default + "bg-[#292929] text-[#8B8B8B] hover:bg-[#292929] hover:text-[#8B8B8B] focus:bg-[#26009F] focus:text-white"
	const class_btn_female_inactive = class_btn_default + "bg-[#292929] text-[#8B8B8B] hover:bg-[#292929] hover:text-[#8B8B8B] focus:bg-[#600298] focus:text-white"
