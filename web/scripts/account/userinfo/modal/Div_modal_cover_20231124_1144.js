function Div_modal_cover() {
	return (
		<div class={class_modal}>
			...
			<div class="relative bg-[#262626] rounded-lg shadow">
				...
				<div class="flex flex-col justify-center items-center w-full">
					<div class={class_modal_btn_container}>
						...
						<button class={class_modal_btn_yes} onClick={() => document.getElementById('id_file_input_cover').click()}>
							새 이미지 업로드
						</button>
					</div>
			...
			<input type="file" name="id_file_input_cover" id="id_file_input_cover" class="hidden"  accept="image/*" onChange={() => check_file_upload_cover() }/>
		</div>
	)
}