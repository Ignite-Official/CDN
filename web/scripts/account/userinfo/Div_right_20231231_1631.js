function Div_right() {
	...
	function click_tab(title) {
		if (title == "introduction") {
			...
			document.getElementById("tab_introduction").className = class_tab_enabled
			document.getElementById("tab_portfolio_list").className = class_tab_disabled
			document.getElementById("tab_teamup_list").className = class_tab_disabled
			...
			document.getElementById("tab_introduction").className = class_tab_disabled
			document.getElementById("tab_portfolio_list").className = class_tab_enabled
			document.getElementById("tab_teamup_list").className = class_tab_disabled
			...
			document.getElementById("tab_introduction").className = class_tab_disabled
			document.getElementById("tab_portfolio_list").className = class_tab_disabled
			document.getElementById("tab_teamup_list").className = class_tab_enabled
		}
	}
	...
	return (
		<div class="flex flex-col justify-center items-center w-full space-y-[24px] rounded-xl px-[48px] md:px-[0px]">
			<div class="flex flex-row w-full border-b-2 border-gray-500">
				<p id="tab_introduction" class={class_tab_enabled} onClick={() => click_tab("introduction")}>
					소개
				</p>
				<p id="tab_portfolio_list" class={class_tab_disabled} onClick={() => click_tab("portfolio_list")}>
					포트폴리오
				</p>
				<p id="tab_teamup_list" class={class_tab_disabled} onClick={() => click_tab("teamup_list")}>
					소속 팀업
				</p>
			</div>
