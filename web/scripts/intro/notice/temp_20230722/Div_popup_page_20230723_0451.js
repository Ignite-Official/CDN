function Div_popup_page(props) {
	return (
		<div class="flex flex-col justify-center items-center cursor-pointer bg-white space-y-[0px] rounded-t-lg">
			...
			<div class="flex flex-row justify-center items-center text-center w-[328px] h-[40px] pt-[22px]">
			...
			{
				props.page == 8
				? <img src={props.image} class="w-[328px] pt-[22px] rounded-lg"/>
				: <img src={props.image} onClick={() => change_popup(props.page + 1)} class="w-[328px] pt-[22px] rounded-lg"/>
			}
