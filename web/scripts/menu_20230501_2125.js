...
function menu() {
	let class_btn = "inline-flex items-center text-sm text-white rounded-lg ml-[12px] w-[24px] h-[24px] hover:bg-gray-100 hover:text-black focus:outline-none focus:ring-2 focus:ring-gray-200"
