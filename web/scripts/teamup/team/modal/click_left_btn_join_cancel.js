async function click_left_btn_join_cancel() {
	function Div_modal_join_cancel_btn_list() {
		return (
	...
	function Div_modal_join_cancel_btn_list_loading() {
		return (
			<div class={class_modal_btn_container}>    
	...
	if (!toggle_click_left_btn_join_cancel) {
		...
		const data = await fetch("/teamup/ajax_cancel_team_join/", {
							method: "post", 
