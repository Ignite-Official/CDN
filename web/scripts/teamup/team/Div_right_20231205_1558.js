		...
		<div class="flex flex-col justify-center items-center w-full space-y-[24px] rounded-xl px-[48px] md:px-[0px]">
			...
			<div class="flex flex-col w-full space-y-[24px]">
				...
				<div id="div_right_role_list" class="w-full">
					<div class="grid grid-cols-4 w-full justify-center items-center gap-[12px] md:grid-cols-2 animate-pulse">
						<Div_member_counter_card_skeleton />
						<Div_member_counter_card_skeleton />
						<Div_member_counter_card_skeleton />
						<Div_member_counter_card_skeleton />
					</div>
			...
			<div class="flex flex-col justify-center items-center w-full">
				<div class="flex flex-row justify-start items-center w-full">
					...
					<p id="tab_rifgr_sending_list" class="hidden">
						보낸 요청
					</p>
				</div>
			</div>
