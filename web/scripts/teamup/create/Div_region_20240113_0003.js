function Div_region() {
	return (
		<div class="flex flex-col justify-center items-start w-full space-y-[12px]">
			...
			<div class="flex flex-col px-[20px] py-[10px] space-y-[10px] overflow-auto" id="div_region_online">
				<Div_online_enable />
			</div>

			<div class="flex flex-col h-[200px] min-h-[200px] max-h-[200px] px-[20px] space-y-[10px] overflow-auto">
