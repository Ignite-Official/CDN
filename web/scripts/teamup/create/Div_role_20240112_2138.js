				...
				<div class="flex flex-col w-full">
					...
					<div class="grid grid-cols-3 w-full justify-center items-center px-4">
						...
						<div class="px-1 w-full">
							<button class="text-white bg-[#340BB8] font-medium rounded-lg text-sm px-5 py-2.5 text-center w-full hover:bg-[#26009F] focus:border focus:border-[#FFFFFF]" id="btn_add_role"
