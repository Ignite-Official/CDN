...
function click_btn_add_genre(type) {
	if (type == "artist") {
		...
		if (new_genre_name != "" &&
			...
			// 모달 안의 장르 목록 표시
			ReactDOM.render(<Div_genre_list data={data_artist_genre} />, document.getElementById("div_artist_genre_list"));
		}
		...
		if (new_genre_name != "" &&
			...
			// 모달 안의 장르 목록 표시
			ReactDOM.render(<Div_genre_list data={data_team_genre} />, document.getElementById("div_team_genre_list"));
		}
