	...
	return (
		<div class="w-full">
			<div class="flex flex-row space-x-[12px] justify-start items-center
				...
				<div class={class_filter_button} id={"btn_filter_" + props.type + "_teamup"}>
					<Div_filter_button title={"팀업 상태"} content={"전체"}
									   function={() => document.getElementById("btn_modal_filter_" + props.type + "_teamup").click()} />
				</div>
				<div class={class_filter_button} id={"btn_filter_" + props.type + "_online"}>
					<Div_filter_button title={"온라인"} content={"전체"}
									   function={() => document.getElementById("btn_modal_filter_" + props.type + "_online").click()} />
				</div>
