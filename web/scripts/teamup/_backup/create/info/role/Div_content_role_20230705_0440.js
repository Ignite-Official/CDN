function Div_content_role(props) {
	...
	return(
		<div class="flex flex-col justify-center items-center text-start w-[360px] h-fit py-[12px] pr-[16px] mx-auto">
			<p class="w-[360px] px-[16px] mb-[22px] text-[12px] font-[500] text-[#8B8B8B]">한 분야에서 최대 10명까지 모집이 가능해요.</p>
			<div id="div_list_role_members" class="hidden"></div>
