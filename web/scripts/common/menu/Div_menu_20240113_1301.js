function Div_menu() {
			...
			<div class="flex justify-between items-center h-[48px]">
				...
				<div id="menu_name" class="flex justify-center items-center space-x-[40px] md:hidden">
					...
					<span class="flex flex-row justify-center items-center text-white text-[14px] font-[600] cursor-pointer 
						...
						<img src="https://cdn.jsdelivr.net/gh/Ignite-Official/CDN/web/image/svg/letter.svg" class="w-[18px] h-[18px]"/>
					</span>
					...
					<span class="flex flex-row justify-center items-center text-white text-[14px] font-[600] cursor-pointer
						  ...
						  <img src="https://cdn.jsdelivr.net/gh/Ignite-Official/CDN/web/image/svg/bell.svg" class="w-[24px] h-[24px]" />
					</span>
	...
	function Div_menu_mobile() {
		return (
			<div id="div_menu_mobile" class="hidden">
				...
				<div class={ 
								gv_username == ""
								? "grid grid-cols-4 sm:grid-cols-3 text-white"
								: "grid grid-cols-5 sm:grid-cols-4 text-white"
						   }>
	...
	return (
		<nav class="bg-backgroundblack border-gray-200 w-full justify-center items-center 
			...
			<Div_menu_pc />
			<Div_menu_mobile />
			<div id="div_letter" class="hidden"></div>
			<div id="div_alert" class="hidden"></div>
		</nav>
	)
}