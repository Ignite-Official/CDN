	...
	return (
		<div class="flex flex-col w-full bg-black text-white">
			...
			<div class="flex flex-row justify-between
				...
				<div class="flex flex-col w-3/4 sm:w-full">
					...
					<div class="flex flex-row items-center text-center text-[14px] font-[600] text-white pb-[12px] space-x-[12px] hidden md:flex md:visible">
				...
				<div class="flex justify-end items-start visible sm:hidden">
