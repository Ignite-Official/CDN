function Div_team_card(props) {
	return (
		<div class={"flex flex-col justify-start items-between rounded-lg space-y-[12px] p-[16px] "
					+ "bg-[#1D1D1D] "
					+ "w-full min-w-[300px] max-w-[300px] h-fit min-h-[140px] mx-auto " 
			...
			<div class="flex flex-wrap justify-start items-center space-x-[4px] space-y-[4px]">
				<div></div>
				...
				{
					props.region_count == 0 || props.region_name == null
					?   <p class="flex flex-row justify-center items-center bg-[#404040] text-white font-[400] text-[12px] w-fit h-[22px] px-[8px] rounded-md">
							전국
						</p>
					:   ""
				...
				{
					props.region_count == 1 && props.region_name != null
					?   <p class="flex flex-row justify-center items-center bg-[#404040] text-white font-[400] text-[12px] w-fit h-[22px] px-[8px] rounded-md">
							{props.region_name}
						</p>
					:   ""
				}
				{
					props.region_count > 1 && props.region_name != null
					?   <p class="flex flex-row justify-center items-center bg-[#404040] text-white font-[400] text-[12px] w-fit h-[22px] px-[8px] rounded-md">
							{props.region_name} 외 {props.region_count - 1}곳
						</p>
					:   ""
				}

				{
					props.genre_count == 0 || props.genre_name == null
					?   <p class="flex flex-row justify-center items-center bg-[#404040] text-white font-[400] text-[12px] w-fit h-[22px] px-[8px] rounded-md">
							모든 장르
						</p>
					:   ""
				...
				{
					props.genre_count == 1 && props.genre_name != null
					?   <p class="flex flex-row justify-center items-center bg-[#404040] text-white font-[400] text-[12px] w-fit h-[22px] px-[8px] rounded-md">
							{props.genre_name}
						</p>
					:   ""
				}
				{
					props.genre_count > 1 && props.genre_name != null
					?   <p class="flex flex-row justify-center items-center bg-[#404040] text-white font-[400] text-[12px] w-fit h-[22px] px-[8px] rounded-md">
							{props.genre_name} 외 {props.genre_count - 1}개
						</p>
					:   ""
				}

				{
					props.role_count == 0 || props.role_name == null
					?   <p class="flex flex-row justify-center items-center bg-[#404040] text-white font-[400] text-[12px] w-fit h-[22px] px-[8px] rounded-md">
							모든 역할
						</p>
					:   ""
				...
				{
					props.role_count == 1 && props.role_name != null
					?   <p class="flex flex-row justify-center items-center bg-[#404040] text-white font-[400] text-[12px] w-fit h-[22px] px-[8px] rounded-md">
							{props.role_name}
						</p>
					:   ""
				}
				{
					props.role_count > 1 && props.role_name != null
					?   <p class="flex flex-row justify-center items-center bg-[#404040] text-white font-[400] text-[12px] w-fit h-[22px] px-[8px] rounded-md">
						{props.role_name} 외 {props.role_count - 1}개
						</p>
					:   ""
				}
