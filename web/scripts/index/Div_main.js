		...
		<div class="w-full">
			...
			<div class="flex flex-col w-full px-[100px] py-[40px] sm:px-[20px] sm:py-[16px]">
				<div class="items-center w-full rounded-xl">
					<div class="flex flex-row w-full h-[90px] rounded-xl bg-[#340BB8]">
					</div>
				</div>
			</div>
			...
			<div class="flex flex-col w-full px-[100px] py-[40px] sm:px-[20px] sm:py-[16px]">
				...
				<div class="items-center pt-4" id="div_collaborator_contents"></div>
			</div>
		
			<div class="flex flex-row justify-center items-center text-start w-full h-[300px] sm:h-[180px]
						bg-[url('https://cdn.jsdelivr.net/gh/Ignite-Official/CDN/web/image/svg/banner_footer.svg')] bg-cover">
			</div>
			...
			<div class="flex flex-col w-full px-[100px] py-[40px] sm:px-[20px] sm:py-[16px]">
				<div id="div_songcamp_title"></div>
				<div class="flex items-start pt-4" id="div_songcamp_contents">
				</div>
			</div>
		
			<div class="flex flex-col w-full px-[100px] py-[40px] sm:px-[20px] sm:py-[16px]">
				<div id="div_contest_title"></div>
				<div class="flex items-start pt-4" id="div_contest_contents">
				</div>
			</div>
		</div>
	)
