async function get_mypage_portfolio_info() {
	// 현재 경로
	...
	if (mode == "edit_portfolio") {
		ReactDOM.render(<Div_portfolio_edit data={data} email={data_email} />, document.getElementById("div_portfolio"));   

		// 내 포트폴리오에 들어왔을 때만 수정하기 버튼이 나타난다.
		if (current_email == data_email) {
