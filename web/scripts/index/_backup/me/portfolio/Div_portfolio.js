	...
	const portfolio_list = Object.keys(props.data).map((btn_data) =>
		<div class="flex flex-col justify-center items-center pb-[50px]">
			...
			<div class="flex justify-between items-center w-[360px] max-w-[360px] mt-[19px]">
				...
				<div class="flex flex-row justify-end items-center w-fit min-w-[70px] max-w-[100px] pl-[4px] pr-[4px]"
					 id={"btn_respect_" + props.data[btn_data].uuid}>
					 <Div_button_respect uuid={props.data[btn_data].uuid} count={props.data[btn_data].cnt_respect} />
				</div>
			</div>
