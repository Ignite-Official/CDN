...
function Div_profile_edit(props) {    
	return (
		<div class="flex flex-col pb-[180px]">
			...
			<a href='/account/userinfo/genre/' 
			   class="w-[360px] max-w-[360px] pl-[16px] pr-[16px] mt-[24px] pb-[24px] space-y-[6px] border-b-2 border-[#292929]">
				<div href='/account/userinfo/genre/' class="flex flex-row justify-between items-center text-start">
					<div class="flex flex-row justify-between items-center">
					...
					<img src="https://cdn.jsdelivr.net/gh/Ignite-Official/CDN/web/image/svg/right_angle.svg"
						 class="w-[7px] h-[10px] cursor-pointer"/>
				</div>
			</a>


			<a href='/account/userinfo/role/'
			   class="w-[360px] max-w-[360px] pl-[16px] pr-[16px] mt-[24px] pb-[24px] space-y-[6px] border-b-2 border-[#292929]">
				<div class="flex flex-row justify-between items-center text-start">
					<div class="flex flex-row justify-between items-center">
